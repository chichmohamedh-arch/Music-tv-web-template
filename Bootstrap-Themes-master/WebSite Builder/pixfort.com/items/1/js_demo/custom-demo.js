        ...
        if(proceed){
            ...
            setTimeout(
                function()
                {
                    ...
                    var alert_msg = '<div class="alert alert-success" role="alert" style="display:none;">Thank you for submitting the form</div>';
    ...
    $(window).on('resize', function(){
        if($(this).width() != width){
            ...
            if(width>768){
                ...
                if($('.pix_nav_menu').attr('data-scroll-bg')){
                    var mob_bg = $('.pix_nav_menu').attr('data-scroll-bg');
                    $('.pix_nav_menu').css('background', mob_bg);
                }
            }
